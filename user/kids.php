                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#top" class="active">Kid's</a></li>
                            <li class="submenu">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2 style="text-align: left">Kid's Latest</h2>
                        <span>Take a closer look at the details of the children's clothes you want to look for.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($data = mysqli_fetch_array($query)) {
                        if ($data["id_gender"] == '3' && $data["id_status"] == '1') {
