...
<body>
    ...
    <?php
    include '../koneksi.php';
    $query = mysqli_query($conn, "SELECT * from produk as p join ukuran_produk as up on p.id_ukuran = up.id_ukuran join status_produk as sp on p.id_status = sp.id_status ORDER BY p.id ASC;");
    ?>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#top" class="active">Women's</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2 style="text-align: left">Women's Latest</h2>
                        <span style="text-align: left">Take a closer look at the details of the women's clothes you want to look for.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($data = mysqli_fetch_array($query)) {
                        if ($data["id_gender"] == '2' && $data["id_status"] == '1') {
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="single-product.php?id=<?php echo $data["id"] ?>"><i class="fa fa-eye"></i></a></li>
                                            <li><a href="single-product.php?id=<?php echo $data["id"] ?>"><i class="fa fa-star"></i></a></li>
                                            <li><a href="single-product.php?id=<?php echo $data["id"] ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
